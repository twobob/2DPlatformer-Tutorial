...
public class CameraFollow : MonoBehaviour {
    ...
    public float maxAdjCamPos;
    public float adjCamPosSpeed;
    Vector2 adjCameraPosition;
    ...
    void LateUpdate() 
    {
        ...
        //Vector3 currentCameraPosition = new Vector3(Input.GetAxisRaw("altHorizontal") * maxAdjCamPos.x, Input.GetAxisRaw("altVertical") * maxAdjCamPos.y, 0f);
        //currentCameraPosition.Normalize();
        //adjCameraPosition = Vector3.MoveTowards(adjCameraPosition, currentCameraPosition, adjCamPosSpeed);

        //transform.position = adjCameraPosition + newPosition;
